...
export default {
    ...
    methods: {
        ...
        addToGoogle(event) {
            ...
            window.open('https://calendar.google.com/calendar/hosted/continued.com/event?' + $.param(options));
            // window.open('https://calendar.google.com/calendar/hosted/alliedhealthmedia.com/event?' + $.param(options));
        },
