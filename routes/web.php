...
Route::group([
    ...
    Route::post('/holidays/bulk_half', 'AdminHolidaysController@bulk_half_store')->name('holidays.halfstore');
...
Route::post('/ptos/approve/{id}', 'PaidTimeOffsController@approve')->name('pto.approve')->middleware('manager');
Route::post('/ptos/deny/{id}', 'PaidTimeOffsController@deny')->name('pto.deny')->middleware('manager');
Route::post('/ptos/destroy/{id}', 'PaidTimeOffsController@destroy')->name('pto.destroy')->middleware('manager');
Route::post('/ptos/owner-destroy/{id}', 'PaidTimeOffsController@ownerDestroy')->name('pto.owner.destroy')->middleware('auth');
Route::post('/ptos/sent_to_calendar/{id}', 'PaidTimeOffsController@sent_to_calendar')->name('pto.sent_to_calendar')->middleware('manager');
